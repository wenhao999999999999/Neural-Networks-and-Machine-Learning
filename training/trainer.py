...
def train_loop(model, train_ds, val_ds, cfg: dict, out_dir):
    ...
    scheduler = torch.optim.lr_scheduler.ReduceLROnPlateau(
        optim, mode="min", factor=0.5, patience=max(1, cfg["train"]["patience"] // 2),
    ...
    for epoch in range(1, cfg["train"]["epochs"] + 1):
        ...
        print(f"Epoch {epoch:03d} | train {train_loss:.6f} | val {val_loss:.6f} | lr {optim.param_groups[0]['lr']:.2e}")
